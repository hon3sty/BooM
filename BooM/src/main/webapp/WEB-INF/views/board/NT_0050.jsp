...
<!-- 					        </div> -->
				...
				<div id="ntc1">
					...
					<form name="updateForm" method="post" action="noticeUpdate.bo" id="ntc2" enctype="multipart/form-data">
								...
								<tbody>
									<tr>
										...
										<td colspan="3" style="width:700px;">
											<input type="text" name="boardTitle" value="${b.boardTitle }" id="qnaCustInqTitle" class="input-text" maxlength="100">
										</td>
									</tr>
									<tr>
										<th scope="row">
										...
										<td colspan="3" style="width:700px;">
											<div class="textarea">
												...
												class="input-textarea" placeholder="내용 입력" style="width:100%;" maxlength="500">${b.boardContent }</textarea>
												<div class="util">
										...
										<td colspan="3">
											<div class="file-upload preview-image">
											    ...
											    <input type="file" id="input-file" class="upload-hidden" style="display:none;" name="upfile"> 
											   	 <c:if test="${not empty ba.originName}">
									   	 			현재 업로드된 파일 : 
  														...
  														<input type="hidden" name="originName" value="${ba.originName }">
  														<input type="hidden" name="saveName" value="${ba.saveName }">
												</c:if>
											</div>
										</td>
									</tr>
