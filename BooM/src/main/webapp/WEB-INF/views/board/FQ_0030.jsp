...
<!-- 					        </div> -->
				...
				<!-- 리스트 영역 시작 -->
				<div id="ntc1">
					<h2 class="tit">자주하는 질문 수정</h2>
					<form name="enrollForm" method="post" action="faqUpdate.bo" id="faqUpdateForm">
						...
						<div class="faqcategory">
					     <div class="select-wrap">
					     	<dl>
								<select name="categoryNo" id="categoryNo" value="${b.categoryNo}" class="form-control" onchange="changeSelect()">
									<option value="10">영화예매</option>
									<option value="20">결제/환불</option>
									<option value="30">극장</option>
									<option value="40">스토어</option>
									<option value="50">특별관</option>
									<option value="60">VIP</option>
									<option value="70">멤버십</option>
									<option value="80">관람권</option>
					            </select>
							</dl>
	                	</div>
					   </div>
								...
								<tbody>
									<tr>
										...
										<td colspan="3" style="width:700px;">
											<input type="text" name="boardTitle" id="qnaCustInqTitle" value="${b.boardTitle }" class="input-text" maxlength="100" required>
										</td>
									</tr>
									<tr>
										<th scope="row">
										...
										<td colspan="3" style="width:700px;">
											<div class="textarea">
												...
												class="input-textarea" placeholder="내용 입력" style="width:100%;" maxlength="500" required>${b.boardContent }</textarea>
												<div class="util">
