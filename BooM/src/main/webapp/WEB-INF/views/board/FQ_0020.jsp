...
<!-- 					        </div> -->
				...
				<div id="ntc1">
					...
					<form name="enrollForm" method="post" action="faqInsert.bo" id="ntc2" enctype="multipart/form-data">
						...
						<div class="faqcategory">
					     <div class="select-wrap">
					     	<dl>
							  <select name="bCategoryNo" id="faqCate" value="카테고리" class="form-control">
								...
								<tbody>
									<tr>
										...
										<td colspan="3" style="width:700px;">
											<input type="text" name="boardTitle" id="qnaCustInqTitle" class="input-text" maxlength="100" required>
										</td>
									</tr>
									<tr>
										<th scope="row">
										...
										<td colspan="3" style="width:700px;">
											<div class="textarea">
												...
												class="input-textarea" placeholder="내용 입력" style="width:100%;" maxlength="500" required></textarea>
												<div class="util">
